...
public class ThemeLocalTable extends AbsDataTable {
	// ===========================================================
	// Constants
	// ===========================================================
	public static final String TABLE_NAME = "theme_local";	
	public static final int TABLE_VERSION = 2;
	public static final Uri LOCAL_THEME_URI = Uri.parse("content://" + DataProvider.DATA_AUTHORITY + "/" + TABLE_NAME);
