package com.nqmobile.livesdk.modules.gamefolder_v2.table;
...
/**
 * 游戏文件夹缓存表，在AppCacheTable的基础上添加字段
 * @author chenyanmin
 * @date 2014-10-26
 */
public class GameCacheTable extends AbsDataTable {
    // ===========================================================
    // Constants
    // ===========================================================
	private static final ILogger NqLog = LoggerFactory.getLogger(GameFolderV2Module.MODULE_NAME);
	public static final String TABLE_NAME = "game_cache";
