...
/**
 * 虚框文件夹应用预取表，同AppCacheTable
 * @author caozhongzheng
 * @date 2014-11-20
 */
public class AppStubFolderAppCacheTable extends AbsDataTable {
    // ===========================================================
    // Constants
    // ===========================================================	
	public static final String TABLE_NAME = "stubfolder_app_cache";	
	...
	public static final String APP_STUB_ENABLE = "enable";// 有效 1， 默认无效0.
															// icon预取成功后会有效
    // ===========================================================
    // Fields
    // ===========================================================
	...
	public void create(SQLiteDatabase db) {
		try{
			db.execSQL("CREATE TABLE IF NOT EXISTS " + TABLE_NAME + "(" +
					...
					APP_STUB_ENABLE + " INTEGER default 0," +
