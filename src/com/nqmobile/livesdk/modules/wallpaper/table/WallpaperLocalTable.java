...
public class WallpaperLocalTable extends AbsDataTable {
	// ===========================================================
	// Constants
	// ===========================================================
	public static final String TABLE_NAME = "wallpaper_local";	
	public static final int TABLE_VERSION = 2;
	public static final Uri LOCAL_WALLPAPER_URI = Uri.parse("content://" + DataProvider.DATA_AUTHORITY + "/" + TABLE_NAME);
	...
	public void create(SQLiteDatabase db) {
		try{
			db.execSQL("CREATE TABLE IF NOT EXISTS " + TABLE_NAME + "(" +
					...
					WALLPAPER_DOWNLOAD_ID +" INTEGER default 0" +
					")"
			);
