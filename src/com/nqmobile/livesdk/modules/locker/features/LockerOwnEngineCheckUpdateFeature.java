 ...
 *
 */
public class LockerOwnEngineCheckUpdateFeature extends AbsFeature {
	// ===========================================================
	// Constants
	// ===========================================================
	private static final int FEATURE = 1010;
	...
	// Constructors
	// ===========================================================
	public LockerOwnEngineCheckUpdateFeature() {
	...
	public String getVersionTag() {
		...
		String versionTag = PreferenceDataHelper.getInstance(mContext)
				.getStringValue(PreferenceDataHelper.KEY_ENGINE_LIB_LD_VERSION);
		return versionTag;
	}
