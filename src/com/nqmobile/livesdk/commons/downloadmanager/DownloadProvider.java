...
public final class DownloadProvider extends ContentProvider {
	...
	if (Binder.getCallingPid() != Process.myPid()) {
	    ...
	    //this COLUMN_STATUS must be added, otherwise may not be able to resume paused download in some case, liujiancheng add
	    copyInteger(Downloads.COLUMN_STATUS, values, filteredValues);
	    
	    //if user resume a download, means 3g/wifi both allowed
