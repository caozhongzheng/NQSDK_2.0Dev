...
public final class Downloads implements BaseColumns {
     ...
     */
    public static final String AUTHORITY = ClientInfo.getPackageName() +".download";
     ...
     * @hide
     */
    public static final String PERMISSION_ACCESS = "com.nqmobile.live.permission.ACCESS_DOWNLOAD_MANAGER";
     ...
     * @hide
     */
    public static final String PERMISSION_ACCESS_ADVANCED = "com.nqmobile.live.permission.ACCESS_DOWNLOAD_MANAGER_ADVANCED";

    /**
     * The permission to access the all the downloads in the manager.
     */
    public static final String PERMISSION_ACCESS_ALL = "com.nqmobile.live.permission.ACCESS_ALL_DOWNLOADS";
     ...
     * @hide
     */
    public static final String PERMISSION_SEND_INTENTS = "com.nqmobile.live.permission.SEND_DOWNLOAD_COMPLETED_INTENTS";

    /**
     * The permission to download files without any system notification being
     * shown.
     */
    public static final String PERMISSION_NO_NOTIFICATION = "com.nqmobile.live.permission.DOWNLOAD_WITHOUT_NOTIFICATION";
     ...
     * com.nqmobile.live.permission.ACCESS_DOWNLOAD_MANAGER_ADVANCED.
     * <P>
     * Type: INTEGER
     * </P>
     * <P>
    ...
    /**
     *  Threads control number, max threads number which are running status meanwhile
     */
	public static final int MAX_THREADS_RUNNING = 3;  
